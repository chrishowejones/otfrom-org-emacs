...
*** solarized
    ...
    #+BEGIN_SRC emacs-lisp
       (maybe-install-and-require 'solarized)
    #+END_SRC
...
*** set up erc for slack - clojurians
    ...
    #+BEGIN_SRC emacs-lisp
      (defun erc-clojurians ()
        (interactive)
         (erc-tls :server "clojurians.irc.slack.com" :full-name "Chris Howe-Jones" :nick "agile_geek" :password "drokkit1"))
    #+END_SRC
     ...
     (defun comms ()
       ...
       (if (< (frame-width) 240)
           (progn
             ...
             ;; twitter on the left
             (window-number-select 1)
             (switch-to-buffer "chrishowejones/people-i-know")
             (window-number-select 2)
