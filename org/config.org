...
*** palimpsest mode
    ...
    I saw this in a presentation on using Emacs for writers where the
    speaker was using this to send text to top or bottom of a text
    file

    #+BEGIN_SRC emacs-lisp
     (maybe-install-and-require 'palimpsest)
...
*** Indium
    ...
    I saw this had a REPL so thought I'd try it.
...
*** LSP Java
    ...
    #+BEGIN_SRC emacs-lisp
      ;; (maybe-install-and-require 'lsp-java)
      ;; (add-hook 'java-mode-hook #'lsp-java-enable)
      ;; ;; set the projects that are going to be imported into the workspace.
      ;; (setq lsp-java--workspace-folders (list "/home/chris/gs-spring-boot"
      ;;                                         "/home/chris/eclipse-workspace/"
      ;;                                         "/home/chris/IdeaProjects/ShoppingCart"
      ;;                                         "/home/chris/IdeaProjects/ShoppingCartExample"))
      ;; (setq lsp-ui-sideline-update-mode 'point)
      ;; (maybe-install-and-require 'lsp-ui)
      ;; (add-hook 'lsp-mode-hook 'lsp-ui-mode)
      ;; (add-hook 'java-mode-hook 'flycheck-mode)
      ;; (maybe-install-and-require 'company-lsp)
...
*** Ruby mode
    ...
    #+BEGIN_SRC emacs-lisp
     ...
     (add-hook 'ruby-mode 'my-paredit-nonlisp)
    #+END_SRC
