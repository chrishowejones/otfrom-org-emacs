     ...
     #+BEGIN_SRC emacs-lisp
       ...
       (setq gnus-alias-identity-alist
             '(("gmail"
               ...
               ("DevCycle"
                nil
                "Chris Howe-Jones <chris.howejones.com>" ;; Sender address
                "DevCycle Ltd"
                (("Fcc" . "/home/bld/maildir/devcycle/sent"))
                nil
                "~/.signature.work")))
...
*** email with mu and mu4e
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (require 'mu4e)
      (setq mu4e-user-mail-address-list (list "chris.howejones@gmail.com" "chris@devcycle.com"))
    #+END_SRC
...
***** The default account.
      ...
      #+BEGIN_SRC emacs-lisp
        (setq mu4e-refile-folder "/devcycle/all"
