...
** company
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq company-idle-delay 0.4)                         ; decrease delay before autocompletion popup shows
...
*** Company box frontend
    ...
    Add company box as a frontend. It's got great icon support that helps differentiate between backends and also
    supports some ui docs enhancements.
...
** Editorconfig
   ...
   Use editorconfig to standardise across a project.
...
** Suppress paredit reindent defun for some modes

   Sometimes paredit-reindent-defun messes up formatting for modes like JS and TS.

   #+BEGIN_SRC emacs-lisp
     (defun suppress-paredit-reindent-defun ()
       (interactive)
...
**** boot
***** treat .boot  and repl files as clojure source
...
*** js2 refactor
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (add-hook 'js2-mode-hook 'suppress-paredit-reindent-defun)
...
*** Ruby TDD from emacs
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (add-hook 'compilation-finish-functions nil)
    #+END_SRC
...
** Coverage
   ...
   Test coverage display for Jest

   #+BEGIN_SRC emacs-lisp
     (use-package coverage-mode
      :straight (:host github :repo "jcubic/coverage.el" :files ("*.el")))
   #+END_SRC
