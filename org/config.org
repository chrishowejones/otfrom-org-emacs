...
*** Code Review
    ...
    #+BEGIN_SRC emacs-lisp
      (with-eval-after-load 'magit
       (require 'code-review))
      (setq code-review-auth-login-marker nil)
    #+END_SRC
...
*** org-jira
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (setq jiralib-url "https://obrizum.atlassian.net")
    ...
    #+RESULTS:
    | keymap |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
    | keymap | (3 keymap (116 keymap (106 . org-jira-todo-to-jira)) (119 keymap (117 . org-jira-update-worklogs-from-org-clocks)) (99 keymap (117 . org-jira-update-comment) (99 . org-jira-add-comment)) (115 keymap (103 . org-jira-get-subtasks) (99 . org-jira-create-subtask)) (105 keymap (102 . org-jira-get-issues-by-fixversion) (107 . org-jira-copy-current-issue-key) (99 . org-jira-create-issue) (82 . org-jira-refresh-issues-in-buffer) (114 . org-jira-refresh-issue) (97 . org-jira-assign-issue) (110 . org-jira-progress-issue-next) (119 . org-jira-progress-issue) (117 . org-jira-update-issue) (104 . org-jira-get-issues-headonly) (106 . org-jira-get-issues-from-custom-jql) (103 . org-jira-get-issues) (98 . org-jira-browse-issue) (118 . org-jira-get-issues-by-board)) (98 keymap (103 . org-jira-get-boards)) (112 keymap (103 . org-jira-get-projects))) |
    | keymap | (menu-bar keymap (debug menu-item Debug (keymap Debug (Start menu-item Start dap-debug) (Create Debug Template menu-item Create Debug Template dap-debug-edit-template) (Debug last session menu-item Debug last session dap-debug-last) (Recent Sessions menu-item Recent Sessions nil :filter #[257 \302\300!\301"\207 [#[257 \301\302"\207 [dap--debug-configuration -map #[257 \211\211A\262\242\300\301\302""\207 [vector make-closure #[0 \301\300!\207 [V0 dap-debug] 2 nil nil]] 9                                                                                                                                                                                                                                                                                                                                                                    |
...
** Slack
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (slack-register-team
      :name "Obrizum"
      :token (auth-source-pick-first-password
              :host "obrizum.slack.com"
              :user "chris.howe-jones@obrizumgroup.com")
      :cookie (auth-source-pick-first-password
               :host "obrizum.slack.com"
               :user "chris.howe-jones@obrizumgroup.com^cookie")
      :subscribed-channels '((general productdev engineering-leadership software-engineering)))
   #+END_SRC
