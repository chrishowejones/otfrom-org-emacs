...
- [[#helpers][Helpers]]
  ...
  - [[#install-try][Install Try]]
  - [[#install-straight-package-mgr][Install straight package mgr]]
- [[#globals][Globals]]
  - [[#set-initial-framesize][Set initial framesize]]
  - [[#which-browser][Which browser]]
  - [[#undo-tree][Undo tree]]
  - [[#auto-indent-on-newline][Auto indent on newline]]
  - [[#next-line-add-newlines][Next line add newlines]]
  - [[#upcase-and-downcase-region][upcase and downcase region]]
  - [[#narrowing-the-region-to-what-i-want-to-look-at][Narrowing the region to what I want to look at]]
  - [[#diminish][diminish]]
  - [[#tabs-are-evil][Tabs are Evil]]
  - [[#uniquify][uniquify]]
  - [[#multiple-cursors][Multiple Cursors]]
  - [[#make-emacs-discoverable][Make emacs Discoverable]]
  - [[#what-do-i-use][What do I use]]
  - [[#add-usrbin-to-path][Add /usr/bin to path]]
  - [[#add-exec-path-from-shell][Add exec path from shell]]
  - [[#iy-go-to-char][iy-go-to-char]]
  - [[#remap-m-i-to-back-to-indentation][Remap M-i to back-to-indentation]]
  - [[#loccur-mode][loccur mode]]
  - [[#tooltips-in-echo-area][Tooltips in echo area]]
  - [[#y-and-n-prompts][Y and N prompts]]
  - [[#time-in-status][Time in status]]
  - [[#set-fundamental-mode-for-large-files][Set fundamental mode for large files]]
  - [[#key-chord-mode][Key chord mode]]
  - [[#use-hide-show-minor-mode-everywhere][Use hide show minor mode everywhere]]
  - [[#require-final-newline][require final newline]]
  - [[#load-prefer-newer][Load prefer newer]]
  - [[#enable-eldoc-in-minibuffer][Enable eldoc in minibuffer]]
  - [[#disable-bell][Disable bell]]
  - [[#remap-transpose-sexps][Remap transpose sexps]]
  - [[#mute-dialog-for-safe-variables-list][Mute dialog for safe variables list]]
- [[#non-elpa-and-work-arounds][non-elpa and work arounds]]
  - [[#non-elpa-files][non-elpa files]]
- [[#macintosh-specific-setup][Macintosh Specific Setup]]
  - [[#-is-broken-on-uk-macs][# is broken on UK Macs]]
  - [[#window-number-super-mode][window-number-super mode]]
  - [[#path-is-broken][$PATH is broken]]
  - [[#ns-win-keys-that-i-want-to-die][ns-win keys that I want to die]]
  - [[#command-key-as-meta][command key as meta]]
- [[#make-it-pretty][Make it Pretty]]
  - [[#color-themes][color themes]]
  - [[#fonts][fonts]]
  - [[#bars-menus-and-numbers][bars, menus and numbers]]
...
- [[#tool-configuration][Tool Configuration]]
  - [[#ediff][ediff]]
  - [[#company][company]]
  - [[#base64-add-prefix-command][Base64 (add prefix command)]]
- [[#directories-navigation-searching-movement][directories, navigation, searching, movement]]
  - [[#dired][dired]]
  ...
  - [[#window-and-buffer-tweaking][window and buffer tweaking]]
  - [[#backup-directories][backup directories]]
  - [[#ibuffer][ibuffer]]
  - [[#projectile][projectile]]
  - [[#perspective][perspective]]
  - [[#ag-the-silver-searcher-with-helm][Ag, the silver searcher with helm]]
  - [[#winnow][Winnow]]
  - [[#guide-key][guide key]]
  - [[#which-key][Which key]]
  - [[#expand-region][expand region]]
  - [[#jump-to-top-or-bottom-of-window][Jump to top or bottom of window]]
  - [[#imenu][Imenu]]
...
- [[#text-modes][Text Modes]]
  - [[#text-mode-basics][Text Mode Basics]]
  - [[#org-mode][org-mode]]
  - [[#html-sgml-xml][html, sgml, xml]]
  - [[#markdown][markdown]]
  - [[#adoc-mode-for-asciidoc][adoc mode for asciidoc]]
  - [[#evil-mode-for-my-vim-friends][evil mode for my vim friends]]
- [[#communication-modes][Communication Modes]]
  - [[#twittering-mode][twittering-mode]]
  - [[#tweet-button][Tweet Button]]
  - [[#jabberel-for-gtalk-and-other-jabber-servers][jabber.el for gtalk and other jabber servers]]
  - [[#irc-currently-with-erc][irc, currently with erc]]
  - [[#email][email]]
  - [[#web-browsing][Web Browsing]]
  - [[#hailing-frequencies-or-comms][Hailing Frequencies or comms]]
...
- [[#multimedia][Multimedia]]
  - [[#emms-to-play-music][emms to play music]]
  - [[#image-mode][Image+ mode]]
  - [[#pdf-tools][PDF tools]]
- [[#notification-systems][Notification Systems]]
  - [[#the-great-eye-of-sauron][The great eye of Sauron]]
- [[#local-config][Local Config]]
  - [[#customel][custom.el]]
- [[#utilities-and-general-keybindings][Utilities and General Keybindings]]
  - [[#join-line][join-line]]
  - [[#org-mind-map][Org mind map]]
  - [[#ox-freemind][Ox Freemind]]
- [[#misc][Misc]]
  - [[#clojure-cookbook-next-recipe][clojure cookbook next recipe]]
  - [[#typing-tutor][Typing tutor]]
- [[#finishing][Finishing]]
  - [[#general-cleanup][General Cleanup]]
  - [[#passwords-and-encrypted-things][passwords and encrypted things]]
