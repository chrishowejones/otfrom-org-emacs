...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "es-parse" '("es-" "test-resp")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ob-elasticsearch" '("es-" "org-babel-ex")))
